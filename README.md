...
- <details>
  ...
  - From the product list, by clicking on a product image or product name the user can access the Product
    ...
    product, frame size dropdown menu, quantity input, add or remove from wishlist button, add to cart button and
    the option below to leave a review and rate the product.
...
- <details>
  ...
  - ![blog article list](readme_images/produts-list-page.png)
...
- <details>
    ...
    As part of the web marketing strategy, a newsletter subscription functionality is provided.

   - ![newletter form](readme_images/newsletter-form.png)
